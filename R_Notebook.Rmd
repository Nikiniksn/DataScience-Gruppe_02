...
```{r}
Sammlung$Temperatur <- as.numeric(as.character(Sammlung$Temperatur))
cut(Sammlung$Temperatur, breaks = c(-20, 0, 11, 21), labels ("eisig", "kalt", "warm"), right=FALSE)
```
...
mod7 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung) + as.factor(Wettercode) + as.factor(Warengruppe) + KielerWoche_2 , Sammlung)
```

```{r}
mod1 <- lm(Umsatz ~ Temperatur, test_dataset)
mod2 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit), test_dataset)
mod3 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung), test_dataset)
mod4 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung) + as.factor(Wettercode), test_dataset)
mod5 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung) + as.factor(Wettercode) + as.factor(Warengruppe), test_dataset)
mod6 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung) + as.factor(Wettercode) + as.factor(Warengruppe) + KielerWoche_2, test_dataset)
mod7 <- lm(Umsatz ~ Temperatur + as.factor(Windgeschwindigkeit) + as.factor(Bewoelkung) + as.factor(Wettercode) + as.factor(Warengruppe) + KielerWoche_2 , test_dataset)
